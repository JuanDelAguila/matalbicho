...
$True =1;
$queryRecibido = "UPDATE pedidos_conectados SET fecha_recibido ='$fecha_recibido' AND  SET recibido = '$True' WHERE id ='$id_pedido' AND enviado = '$True' AND id_hospital = '$id_hospital' AND recibido ='$FALSE' ";
